...
const Wm = new Map([
  ...
  Z3 = (n) => {
    ...
    if (!K3(c) || !Q3(n, o)) return !1;
    const h = { type: X3(c), id: bu(), children: [{ text: '' }] },
      v = T.next(o);
    return (
...
const I3 = ({ element: n, attributes: u, children: r }) => {
    const l = n;
    switch (l.type) {
      case ye.HEADING_ONE:
            ...
            children: [
              ...
              U.jsx('div', {
                ...
                children: U.jsx(W2, {
                  ...
                  onKeyDown: (u) => {
                    u.key === 'Enter' && !u.shiftKey && (u.preventDefault(), n.insertBreak());
                  },
                }),
              }),
            ],
...
function n8() {
  return U.jsx(PE, {
    children: U.jsxs(yE, {
      children: [
        U.jsx(sc, { path: '/', element: U.jsx(t8, {}) }),
...
yC.createRoot(document.getElementById('root')).render(
  U.jsx(F.StrictMode, { children: U.jsx(n8, {}) }),
);
