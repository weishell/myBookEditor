...
function h3() {
  return crypto.getRandomValues(d3);
}
function bu(n, u, r) {
  return crypto.randomUUID ? crypto.randomUUID() : D3(n);
}
function D3(n, u, r) {
  var o;
  n = n || {};
  const l = n.random ?? ((o = n.rng) == null ? void 0 : o.call(n)) ?? h3();
  if (l.length < 16) throw new Error('Random bytes length must be >= 16');
  return ((l[6] = (l[6] & 15) | 64), (l[8] = (l[8] & 63) | 128), c3(l));
}
const v3 = (n, u) => {
    g3(n, u) ? n.removeMark(u) : n.addMark(u, !0);
  },
  g3 = (n, u) => {
    const r = n.marks;
    return r ? r[u] === !0 : !1;
  ...
  x3 = ({ attributes: n, children: u, pluginId: r }) =>
    U.jsx(fn, {
      type: ye.LIST_ITEM,
      pluginId: r,
      children: U.jsx('li', { ...n, style: { margin: '4px 0' }, children: u }),
    }),
  O3 = ({ attributes: n, children: u, leaf: r }) => {
    let l = u;
    return (
...
function Q3() {
  ...
  const D = (C, A) => {
      ...
      (B && !B.isCollapsed && (A ? v3(n, C) : m3(n, C)), d(null));
    },
...
const Z3 = [
  ...
  $3 = ({ element: n, attributes: u, children: r }) => {
    const l = n;
    switch (l.type) {
      case ye.HEADING_ONE:
      ...
      case ye.CODE_BLOCK:
        return U.jsx(b3, { attributes: u, children: r, pluginId: l.id });
      case ye.LIST_ITEM:
        return U.jsx(x3, { attributes: u, children: r, pluginId: l.id });
      case ye.NUMBERED_LIST:
    ...
    u = F.useCallback(
      (r) => {
        if (r.key === 'Enter' && !r.shiftKey) {
          ...
          if (K3(v) && J3(n, h)) {
            r.preventDefault();
            const p = { type: X3(v), id: bu(), children: [{ text: '' }] },
              C = T.next(h);
            (le.insertNodes(n, p, { at: C }),
              le.select(n, {
                anchor: { path: [...C, 0], offset: 0 },
                focus: { path: [...C, 0], offset: 0 },
              }));
          }
        }
      },
...
function t8() {
  return U.jsx(PE, {
    children: U.jsxs(yE, {
      children: [
        U.jsx(sc, { path: '/', element: U.jsx(I3, {}) }),
        U.jsx(sc, { path: '*', element: U.jsx(e8, {}) }),
      ],
    }),
  });
}
yC.createRoot(document.getElementById('root')).render(
  U.jsx(F.StrictMode, { children: U.jsx(t8, {}) }),
);
